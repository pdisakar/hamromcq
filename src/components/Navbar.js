        ...
        <div className="container flex flex-wrap items-center justify-between mx-auto">
          ...
          <div className="flex md:order-2">
            ...
            <button
              ...
              type="button"
              className="inline-flex items-center p-2 text-sm text-blue-500 rounded-lg md:hidden hover:bg-blue-100 focus:outline-none focus:ring-2 focus:ring-blue-200 text-white hover:bg-blue-700 focus:ring-blue-600"
